...
// IsApplicable provides a mock function with given fields: _a0
func (_m *Migration) IsApplicable(_a0 upgrade.UpdateMarker) bool {
	ret := _m.Called(_a0)

	var r0 bool
	if rf, ok := ret.Get(0).(func(upgrade.UpdateMarker) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
// Migration_IsApplicable_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsApplicable'
type Migration_IsApplicable_Call struct {
	*mock.Call
}

// IsApplicable is a helper method to define mock.On call
//   - _a0 upgrade.UpdateMarker
func (_e *Migration_Expecter) IsApplicable(_a0 interface{}) *Migration_IsApplicable_Call {
	return &Migration_IsApplicable_Call{Call: _e.mock.On("IsApplicable", _a0)}
}

func (_c *Migration_IsApplicable_Call) Run(run func(_a0 upgrade.UpdateMarker)) *Migration_IsApplicable_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Migration_IsApplicable_Call) Return(_a0 bool) *Migration_IsApplicable_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Migration_IsApplicable_Call) RunAndReturn(run func(upgrade.UpdateMarker) bool) *Migration_IsApplicable_Call {
	_c.Call.Return(run)
	return _c
}
